...
class _FriendsAcceptOptionsWidgetState extends State<FriendsAcceptOptionsWidget>
    with TickerProviderStateMixin {
  late FriendsAcceptOptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FriendsAcceptOptionsModel());
