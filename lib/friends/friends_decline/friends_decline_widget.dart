...
import 'friends_decline_model.dart';
export 'friends_decline_model.dart';

class FriendsDeclineWidget extends StatefulWidget {
  const FriendsDeclineWidget({super.key});

  static String routeName = 'FriendsDecline';
  static String routePath = '/friendsDecline';

  @override
  State<FriendsDeclineWidget> createState() => _FriendsDeclineWidgetState();
}

class _FriendsDeclineWidgetState extends State<FriendsDeclineWidget>
    with TickerProviderStateMixin {
  late FriendsDeclineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FriendsDeclineModel());
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                'YOU AND NOTMILT ARE NOW BIDDIES!',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
