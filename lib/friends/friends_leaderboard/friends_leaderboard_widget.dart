...
import 'friends_leaderboard_model.dart';
export 'friends_leaderboard_model.dart';

class FriendsLeaderboardWidget extends StatefulWidget {
  const FriendsLeaderboardWidget({super.key});

  static String routeName = 'FriendsLeaderboard';
  static String routePath = '/friendsLeaderboard';

  @override
  State<FriendsLeaderboardWidget> createState() =>
      _FriendsLeaderboardWidgetState();
}

class _FriendsLeaderboardWidgetState extends State<FriendsLeaderboardWidget>
    with TickerProviderStateMixin {
  late FriendsLeaderboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FriendsLeaderboardModel());
