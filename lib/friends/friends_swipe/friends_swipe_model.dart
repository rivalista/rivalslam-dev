...
import 'friends_swipe_widget.dart' show FriendsSwipeWidget;
...
class FriendsSwipeModel extends FlutterFlowModel<FriendsSwipeWidget> {
  ...
  // Model for buddiesSwipe component.
  late BuddiesSwipeModel buddiesSwipeModel;
  // Model for buddies component.
  ...
  void initState(BuildContext context) {
    ...
    buddiesSwipeModel = createModel(context, () => BuddiesSwipeModel());
