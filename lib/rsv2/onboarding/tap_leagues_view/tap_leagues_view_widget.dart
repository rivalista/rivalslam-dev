...
import 'tap_leagues_view_model.dart';
export 'tap_leagues_view_model.dart';

class TapLeaguesViewWidget extends StatefulWidget {
  const TapLeaguesViewWidget({
    super.key,
    this.userName,
    this.college,
    this.homeTowm,
  ...
  static String routeName = 'TapLeaguesView';
  static String routePath = '/tapLeaguesView';

  @override
  State<TapLeaguesViewWidget> createState() => _TapLeaguesViewWidgetState();
}

class _TapLeaguesViewWidgetState extends State<TapLeaguesViewWidget> {
  late TapLeaguesViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TapLeaguesViewModel());
