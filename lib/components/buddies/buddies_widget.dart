...
class BuddiesWidget extends StatefulWidget {
...
class _BuddiesWidgetState extends State<BuddiesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuddiesModel());
  }
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                'You have 3 mutual friends, also rooting for the Oriole..',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Barlow Semi Condensed',
